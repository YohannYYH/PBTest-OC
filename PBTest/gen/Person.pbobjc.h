...
typedef GPB_ENUM(Person_FieldNumber) {
  ...
  Person_FieldNumber_Level = 2,
  Person_FieldNumber_Icon = 3,
  Person_FieldNumber_School = 4,
};
...
typedef GPB_ENUM(Man_FieldNumber) {
  Man_FieldNumber_Name = 1,
  Man_FieldNumber_Level = 2,
  Man_FieldNumber_Icon = 3,
  Man_FieldNumber_School = 4,
};

@interface Man : GPBMessage
